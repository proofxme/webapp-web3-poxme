        ...
        <div className="grid gap-4">
          ...
          <div className="border rounded-lg shadow-sm">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="w-[200px] flex items-center gap-4">
              ...
              <TableBody>
                <TableRow className="select-none">
                  <TableCell className="flex items-center gap-4">
                    ...
                    <span className="font-medium">tebayoso</span>
                  </TableCell>
                  <TableCell>
                    Jorge de los Santos
                  </TableCell>
                  <TableCell>
                    <Badge variant="default" className="bg-green-400">Public</Badge>
                  </TableCell>
                  <TableCell>
                    <Badge variant="default" className="bg-green-400">Active</Badge>
                  </TableCell>
                  <TableCell>
                    <Badge variant="default" className="bg-red-400">Private</Badge>
                  </TableCell>
