    ...
    <main className="flex min-h-screen flex-col lg:p-8 h-auto">
      <div className="flex flex-col items-center justify-center w-full h-full py-14 px-12">
        <div className="space-y-3 text-center w-full">
          ...
          <p className="mx-auto text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
            The migration process is a unique opportunity to continue supporting
            @tebayoso during the Proof of X development, while maintaining the
            value you deposited and have an opportunity to claim back the
            investment
          </p>
        ...
        >
          ...
          <span className="block sm:inline">
            Please, read the FAQ section, or contact us in the official telegram
            channel if you have doubts. This is an irreversible migration
            process
          </span>
        </div>
        <h2
