    ...
    <Card className="w-full max-w-full p-10 grid gap-10 flex justify-center mb-12">
      <CardHeader className="items-center space-y-0 gap-4 p-0">
        <div className="grid gap-1 text-center">
          ...
          <CardDescription className="text-xs">Follow us on our social media channels</CardDescription>
        </div>
      </CardHeader>
      <CardContent className="p-0 grid gap-4 ">
        ...
        <div className="flex items-center gap-10 text-sm" style={{color: '#aaa', cursor: 'default'}}>
